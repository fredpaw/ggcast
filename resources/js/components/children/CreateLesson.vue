	      ...
	      <div class="modal-content">
	        ...
	        <div class="modal-body">
		        <div class="form-group">
		        	<input type="text" class="form-control" placeholder="Lesson title" v-model="lesson.title"></input>
		        </div>
		        <div class="form-group">
		        	<input type="text" class="form-control" placeholder="Vimeo video id" v-model="lesson.video_id"></input>
		        </div>
		        <div class="form-group">
		        	<input type="number" class="form-control" placeholder="Episode number" v-model="lesson.episode_number"></input>
		        </div>
		        <div class="form-group">
