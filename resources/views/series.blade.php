		...
		<div class="container text-center">
			<div class="row h-full">
				...
				<div class="col-12 align-self-end text-center">
					<a class="scroll-down-1 scroll-down-inverse" href="#" data-scrollto="section"><span></span></a>
				</div>
			</div>
		</div>
	</header>
	...
	<section class="section bg-gray">
		<div class="container">
			<header class="section-header">
				<h2>Video Lessons</h2>
				<hr>
				<p class="lead">Sneak peek of the lessons already avaiable in this course</p>
			</header>
		</div>
	</section>
@endsection